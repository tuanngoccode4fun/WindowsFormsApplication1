...
----------------
SET @PO = 'B51121010004'--replace @POVALUE  
SET @LOT ='355-2103' --replace @LOTVALUE
SET @USER = 'ERP'--replace @USERVALUE
SET @WAREHOUSE = 'B02' --replace @WAREHOUSEVALUE
SET @LOCATION ='B01-01'--replace @LOCATIONVALUE
SET @QUANTITY = 300 --replace @QUANTITYVALUE
SET @TF001 = 'D301' --replace @TF001
SET @STT = '0001'--replace @STT --SO thu tu se co dinh dang -0001
SET @Confirm = 'Y'-- replace @confirmVAlue
...
UPDATE SFCTA SET MODIFIER = @USER, MODI_DATE =@DATE,FLAG = FLAG+1
,MODI_TIME = @HOUR, MODI_AP ='TLAN', MODI_PRID ='TLAN',
TA017 = TA017+@QUANTITY, TA045 = TA045 + @WEIGHT
WHERE TA001 = @TA001 and TA002 = @TA002 and TA003 = '0020'
END
